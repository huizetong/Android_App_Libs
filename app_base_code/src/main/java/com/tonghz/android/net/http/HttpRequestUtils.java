...
public class HttpRequestUtils {
    public static final int HTTP_WHAT_DEFAULT = 0x81;

    /**
     * NoHttpRequestUtils实例
     */
    private volatile static HttpRequestUtils mInstance;
     ...
     * @param <T>       泛型类型
     */
    public <T> void add(Activity context, Request<T> request, OnHttpResponseListener<T> listener,
